        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><?=$this->lang->line('observer')?$this->lang->line('observer'):'Observer'?></div>
            </div>
          </div>
                    ...
                    <div class="card card-primary">
                      <div class="card-body"> 
                        <table class='table-striped' id='income_list'
                          data-toggle="table"
                          data-url="<?=base_url('users/get_client_list')?>"
                          ...
                          <thead>
                            <tr>
                              ...
                              <th data-field="company" data-sortable="true" data-visible="false"><?=$this->lang->line('company')?htmlspecialchars($this->lang->line('company')):'Company'?></th>
